...
- The compact rating summary should use Shopping Rio Poty's 4.7 rating with restrained gold stars, but label the source simply as “Avaliações no Google”; keep the carousel itself balanced across both units.
